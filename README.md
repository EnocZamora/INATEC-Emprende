...
> Conectando el talento técnico con las oportunidades de nuestra comunidad."
...
1. Clonar el repositorio en la carpeta de preferencia
    ```bash
    git clone https://github.com/EnocZamora/INATEC-Emprende.git
    ```
2. Entra a la carpeta de el proyecto
    ```bash 
    cd Inatec-Emprende
    ```
3. Instala la dependencia de PHP
    ```bash
    composer install
    ```
